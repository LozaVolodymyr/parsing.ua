...
class AngryCurl extends RollingCurl {
    ...
    protected $proxy_test_url       =   'http://ya.ru';
     ...
     * @return bool
     */
    public function load_proxy_list($input, $window_size = 5, $proxy_type = 'http', $proxy_test_url = 'http://ya.ru/', $proxy_valid_regexp = null)
    {
        # writing debug
     ...
     * @return void
     */
    protected function filter_alive_proxy($window_size = 10)
    {
        # writing debug
